...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "DigitalDirham " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"digitaldirhamtools.com", "dnsseed.digitaldirhamtools.com"},
    {"digitaldirhampool.org", "dnsseed.digitaldirhampool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"digitaldirhamtools.com", "testnet-seed.digitaldirhamtools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. DigitalDirham is probably already running."), addrBind.ToString().c_str());
        else
